...
- 📺 **看外语视频和直播**：YouTube、外语新闻、TED、生肉剧集，原声照常播放，字幕实时跟上。
- 📞 **音视频通话**：跨语言通话、海外客服、外语语聊，对方说什么都能看到译文字幕。
- 🎓 **开会与上网课**：外语会议、讲座、线上课程，边听边看译文，不用事后翻记录。
- 🎮 **玩游戏**：外语配音的剧情、海外服语音沟通，不用切出游戏就能看懂。
- 🎧 **听播客与有声书**：只有音频没有画面也没关系，照样能转成字幕。
