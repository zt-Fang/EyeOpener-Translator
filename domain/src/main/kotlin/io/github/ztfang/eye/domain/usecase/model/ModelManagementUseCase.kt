...
class ModelManagementUseCase
    ...
    constructor(
        ...
        /** 观察单个模型状态 */
        fun observeModel(modelName: String): Flow<ModelState> = modelRepository.observeModel(modelName)

        /** 观察所有模型状态 */
        fun observeAllModels(): Flow<List<ModelState>> = modelRepository.observeAllModels()
        ...
        /** 删除模型 */
        suspend fun removeModel(modelName: String): Result<Unit> =
            withContext(Dispatchers.IO) {
        ...
        /** 检查模型是否已下载 */
        suspend fun isModelAvailable(modelName: String): Boolean = modelRepository.getModelPath(modelName) != null
    }
